 ...
 * Taken from:
 * 
 * https://dl.dropboxusercontent.com/u/102969992/blogs/pool/FastObjectPool.java
 * http://ashkrit.blogspot.sg/2013/05/lock-less-java-object-pool.html
 * 
 * @param <T>
 */
...
public class Pool<T> {
	...
	public Pool(Fn<T> factory, int size) throws Throwable {
		...
		for (int x = 0; x < size; x++) {
			objects[x] = new Holder<T>(factory.exec());
		}
		mask = size - 1;
		releasePointer = size;
